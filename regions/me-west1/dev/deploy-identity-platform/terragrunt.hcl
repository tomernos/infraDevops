...
dependency "platform" {
  ...
  mock_outputs = {
    platform_sa_email       = "swpt-mw1-dev-sa-platform-api@sweptlock-dev-844f2.iam.gserviceaccount.com"
    platform_panel_sa_email = "swpt-mw1-dev-sa-platform-panel@sweptlock-dev-844f2.iam.gserviceaccount.com"
  }
